...
<div class="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 lg:p-24 overflow-y-auto bg-background-light dark:bg-background-dark">
...
<h1 class="text-3xl font-black leading-tight tracking-[-0.033em] text-slate-900 dark:text-white">Join the Gallery</h1>
...
<button class="flex items-center justify-center gap-2 rounded-lg bg-white dark:bg-surface-dark border border-slate-200 dark:border-border-dark py-3 px-4 text-sm font-medium text-slate-900 dark:text-white hover:bg-slate-50 dark:hover:bg-border-dark/30 transition-colors">
...
<span class="mx-4 text-xs font-medium text-slate-500 dark:text-text-secondary uppercase">Or register with email</span>
<div class="grow border-t border-slate-200 dark:border-border-dark"></div>
</div>
<!-- The Form -->
<form class="space-y-5" method="POST" action="/App/Controllers/Auth.php">

<!-- Username -->
<label class="flex flex-col gap-1.5">
<span class="text-slate-900 dark:text-white text-sm font-medium leading-normal">Username</span>
<div class="relative">
<input name="username" class="form-input flex w-full rounded-lg border-slate-200 dark:border-border-dark bg-white dark:bg-surface-dark text-slate-900 dark:text-white focus:border-primary focus:ring-1 focus:ring-primary h-12 px-4 placeholder:text-slate-400 dark:placeholder:text-text-secondary/70 text-base transition-colors" placeholder="Choose a unique handle" type="text"/>
</div>
</label>
<!-- Email -->
<label class="flex flex-col gap-1.5">
...
<div class="relative">
<input name="email" class="form-input flex w-full rounded-lg border-slate-200 dark:border-border-dark bg-white dark:bg-surface-dark text-slate-900 dark:text-white focus:border-primary focus:ring-1 focus:ring-primary h-12 px-4 placeholder:text-slate-400 dark:placeholder:text-text-secondary/70 text-base transition-colors" placeholder="name@example.com" type="email"/>
</div>
</label>
<!-- Password -->
<label class="flex flex-col gap-1.5">
...
<input name="password" class="form-input flex w-full rounded-lg border-slate-200 dark:border-border-dark bg-white dark:bg-surface-dark text-slate-900 dark:text-white focus:border-primary focus:ring-1 focus:ring-primary h-12 pl-4 pr-12 placeholder:text-slate-400 dark:placeholder:text-text-secondary/70 text-base transition-colors" placeholder="Create a password" type="password"/>
<button class="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 dark:text-text-secondary hover:text-slate-600 dark:hover:text-white transition-colors" type="button">
...
<!-- Confirm Password -->
<label class="flex flex-col gap-1.5">
<span class="text-slate-900 dark:text-white text-sm font-medium leading-normal">Confirm Password</span>
<div class="relative">
<input name="confirm_password" class="form-input flex w-full rounded-lg border-slate-200 dark:border-border-dark bg-white dark:bg-surface-dark text-slate-900 dark:text-white focus:border-primary focus:ring-1 focus:ring-primary h-12 px-4 placeholder:text-slate-400 dark:placeholder:text-text-secondary/70 text-base transition-colors" placeholder="Re-enter password" type="password"/>
</div>
</label>
<!-- Terms Checkbox -->
<div class="flex items-start gap-3 pt-2">
<div class="flex h-6 items-center">
<input class="h-4 w-4 rounded border-slate-300 dark:border-border-dark bg-white dark:bg-surface-dark text-primary focus:ring-primary/40 focus:ring-offset-0" id="terms" name="terms" type="checkbox"/>
</div>
<div class="text-sm leading-6">
<label class="font-medium text-slate-500 dark:text-text-secondary" for="terms">
                                I agree to the <a class="font-semibold text-primary hover:text-blue-400" href="#">Terms of Service</a> and <a class="font-semibold text-primary hover:text-blue-400" href="#">Privacy Policy</a>.
                            </label>
</div>
</div>
<!-- Submit Button -->
<button class="flex w-full cursor-pointer items-center justify-center rounded-lg h-12 px-4 bg-primary hover:bg-blue-600 active:bg-blue-700 text-white text-base font-bold leading-normal tracking-[0.015em] transition-all shadow-lg shadow-blue-500/20 dark:shadow-blue-900/30 mt-4">
...
<p class="text-center text-sm text-slate-500 dark:text-text-secondary">
                    ...
                    <a class="font-bold text-primary hover:text-blue-400 transition-colors" href="#">Log In</a>
</p>
</div>
</div>
</div>
